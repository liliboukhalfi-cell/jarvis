...
Ce workspace est le Jarvis personnel de Lili. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Lili et je vis en Suisse. Je suis encore en scolarité obligatoire et j'apprends le développement web et l'IA en autodidacte. Mon projet principal est Proactive, une application de santé sur laquelle je m'entraîne.

Mes objectifs prioritaires actuels sont de comprendre l'IA en profondeur et d'apprendre à créer des sites et des applications.

À long terme, je veux devenir experte en IA et pouvoir l'utiliser comme une développeure.

Le domaine où j'ai besoin du plus d'aide en ce moment : développement web, applications et IA.
